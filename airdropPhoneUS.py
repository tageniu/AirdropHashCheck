...
targetstart = '2ee8f'#input('Enter the target hash start fragment: ')
targetend = '35704'#input('Enter the target hash end fragment: ')
areacodelist = [217, 218, 219, 224, 225, 226, 228, 229,
    231, 234]
